...
# handle dataloader running out of shared filed handles
...
def fine_tune():
    ...
    # write class list to model meta file
    model_fn, model_extension = os.path.splitext(config.FINETUNE_MODEL)
    with open(model_fn + '.json', 'w', encoding='utf-8') as f:
        json.dump({"classes": trainDS.classes}, f, ensure_ascii=False, indent=4)
